...
class TrainingSessionActivityViewModelFactory(private val localRepository: LocalRepository, val application: Application, private val id:Int) : ViewModelProvider.Factory{
